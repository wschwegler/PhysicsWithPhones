...
val xvals: MutableList<Float> = mutableListOf()
val yvals: MutableList<Float> = mutableListOf()
val zvals: MutableList<Float> = mutableListOf()
val time: MutableList<Float> = mutableListOf()
var temp = 0.0f
@Composable
fun AccelerometerSensorUI(accelerometerState: AccelerometerSensorState) {
    Column {
        val classA = SingleAxisBaseExperimentFragment()
        val classB = SingleAxisBaseExperimentFragment()
        val classC = SingleAxisBaseExperimentFragment()
        Column {
            xvals.add(accelerometerState.xForce)
            yvals.add(accelerometerState.yForce)
            zvals.add(accelerometerState.zForce)
            time.add(temp)
            temp+=1
            classA.LineChartView(xvals,time)
            classB.LineChartView(yvals,time)
            classC.LineChartView(zvals,time)
